...
function Chat() {
    ...
    useEffect(() => {
        ...
        socket.on("messageReceived", ({ firstName, text }) => {
            ...
            setMessages((messages) => [...messages, { firstName, text, time: new Date() }]);
        });
    ...
    return (
        <div className="w-3/4 mx-auto border border-gray-600 m-5 h-[70vh] flex flex-col">
            ...
            {/* display message */}
            <div className="flex-1 overflow-y-auto scroll-auto mt-16   p-6 space-y-4"
                ref={chatContainerRef}>
                {messages.map((msg, index) => {
                    return (
                        <>
                            <div key={index} className="cakshahat chat-start">
